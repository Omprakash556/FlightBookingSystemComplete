...
public class AdminFlightController {
    ...
    public Flight addFlight(@RequestBody Flight flight) {
        ...
        // Save flight first to generate ID
        Flight savedFlight = flightService.addFlight(flight);

        // Now extract fare data
        FareRequest fareRequest = flight.getFareRequest();
        fareRequest.setFlightId(savedFlight.getFlightId()); // <-- this was the main issue
        ...
        return savedFlight; // return the saved one (with ID populated)
    }
